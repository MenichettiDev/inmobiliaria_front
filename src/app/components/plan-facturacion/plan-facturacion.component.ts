...
@Component({
  selector: 'app-plan-facturacion',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './plan-facturacion.component.html',
  styleUrls: ['./plan-facturacion.component.css']
})
export class PlanFacturacionComponent implements OnInit {
  // Plan actual
  planActual = {
    id: 2,
    nombre: 'Profesional',
