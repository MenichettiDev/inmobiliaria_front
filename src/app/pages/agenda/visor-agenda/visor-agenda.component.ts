...
@Component({
  selector: 'app-visor-agenda',
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './visor-agenda.component.html',
  styleUrl: './visor-agenda.component.css'
})
export class VisorAgendaComponent implements OnInit {
