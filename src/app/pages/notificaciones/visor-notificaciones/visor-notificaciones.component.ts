...
@Component({
  selector: 'app-visor-notificaciones',
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './visor-notificaciones.component.html',
  styleUrl: './visor-notificaciones.component.css'
})
export class VisorNotificacionesComponent implements OnInit {
  // Filtros
  filtros = {
